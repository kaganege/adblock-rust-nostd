...
mod tests {
  ...
  fn deserialization_backwards_compatible_plain() {
    ...
    let serialized = [
      209, 217, 58, 175, 0, 220, 0, 17, 145, 128, 145, 128, 145, 128, 145, 128, 145, 128, 145, 129,
      207, 202, 167, 36, 217, 43, 56, 97, 176, 145, 157, 145, 206, 0, 3, 31, 255, 129, 1, 169, 97,
      100, 45, 98, 97, 110, 110, 101, 114, 192, 192, 192, 192, 192, 192, 192, 192, 207, 186, 136,
      69, 13, 115, 187, 170, 226, 192, 192, 145, 128, 144, 195, 145, 128, 144, 144, 128, 128, 145,
      128, 144, 145, 128,
    ];
    let mut deserialized_engine = Engine::default();
    deserialized_engine.deserialize(&serialized).unwrap();
  ...
  fn deserialization_backwards_compatible_tags() {
    ...
    // converted from the legacy compressed format
    let serialized = [
      209, 217, 58, 175, 0, 220, 0, 17, 145, 128, 145, 128, 145, 128, 145, 128, 145, 128, 145, 128,
      145, 128, 145, 157, 145, 206, 0, 3, 31, 255, 129, 1, 169, 97, 100, 45, 98, 97, 110, 110, 101,
      114, 192, 192, 192, 192, 192, 192, 163, 97, 98, 99, 192, 207, 126, 212, 53, 83, 113, 159,
      143, 134, 192, 192, 195, 145, 128, 144, 144, 128, 128, 145, 128, 144, 145, 128,
    ];
    let mut deserialized_engine = Engine::default();
    ...
    assert!(
      engine
        .check_network_request(
          &Request::new("https://example.com", "https://example.com", "document").unwrap()
        )
        .matched
    );
    assert!(
