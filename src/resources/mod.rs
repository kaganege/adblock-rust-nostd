...
impl core::fmt::Debug for PermissionMask {
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq)]
#[serde(into = "&str")]
#[serde(from = "alloc::borrow::Cow<'static, str>")]
pub enum MimeType {
  /// `"text/css"`
  TextCss,
  /// `"image/gif"`
...
impl From<alloc::borrow::Cow<'static, str>> for MimeType {
  fn from(v: alloc::borrow::Cow<'static, str>) -> Self {
    v.as_ref().into()
  }
}
